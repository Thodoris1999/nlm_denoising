...
int main(int argc, char* argv[]){
    ...
    info_ss << imagename << "_" << w_length << "_parallel_info.txt";
    ...
    for (int i = 0; i < 5; i++) {
        ...
        float* denoised_img = cuda_non_local_means(noisy_img,img_length,w_length,h,patch_sigma);
        ...
        dimg_ss << imagename << "_" << h << "_" << w_length << "parallel_denoised.txt";
        diffimg_ss << imagename <<  "_" << h << "_" << w_length << "parallel_diff.txt";
